 ...
 */
abstract class BaseLoadMultAdapter<T : MultModel, K : RecyclerHolder>(data: MutableList<T>, @LayoutRes loadResId: Int) : BaseLoadAdapter<T, K>(data, loadResId) {
    ...
    override fun createModelHolder(parent: ViewGroup, viewType: Int): K {
        ...
        val inflate = LayoutInflater.from(parent.context.applicationContext).inflate(layoutId, parent, false)
