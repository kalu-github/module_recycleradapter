...
// */
//
//package lib.kalu.recyclerview.adapter.decoration;
//
...
//
//import lib.kalu.recyclerview.adapter.manager.CrashFlexboxLayoutManager;
//
//import static androidx.recyclerview.widget.RecyclerView.NO_POSITION;
//
///**
// * {@link RecyclerView.ItemDecoration} implementation that can be used as item decorations between
// * view holders within the {@link CrashFlexboxLayoutManager}.
// *
...
//            return;
//        }
//        CrashFlexboxLayoutManager layoutManager = (CrashFlexboxLayoutManager) parent.getLayoutManager();
...
//                                         CrashFlexboxLayoutManager layoutManager, List<FlexLine> flexLines) {
//        if (flexLines.size() == 0) {
//            return;
//        }
...
//                                        CrashFlexboxLayoutManager layoutManager, List<FlexLine> flexLines, int flexDirection) {
...
//            CrashFlexboxLayoutManager layoutManager) {
//        int flexLineIndex = layoutManager.getPositionToFlexLineIndex(position);
