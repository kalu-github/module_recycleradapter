 ...
 * 3. 杜绝高内存占用
 */
public class CrashPagerGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {

    private static final String TAG = CrashPagerGridLayoutManager.class.getSimpleName();
     ...
     */
    public CrashPagerGridLayoutManager(@IntRange(from = 1, to = 100) int rows,
    ...
    public void setRowColumn(@IntRange(from = 1, to = 100) int rows, @IntRange(from = 1, to = 100) int columns) {
        mRows = rows;
        mColumns = columns;
        mOnePageSize = mRows * mColumns;
    }
...
//        Loge("Item onLayoutChildren state = " + state);
    ...
    private static final class PagerGridSmoothScroller extends LinearSmoothScroller {
        private RecyclerView mRecyclerView;
        ...
        protected void onTargetFound(View targetView, RecyclerView.State state, Action action) {
            ...
            if (manager instanceof CrashPagerGridLayoutManager) {
                CrashPagerGridLayoutManager layoutManager = (CrashPagerGridLayoutManager) manager;
    ...
    public final static class PagerGridSnapHelper extends SnapHelper {
...
//            Loge("findTargetSnapPosition, pos = " + pos);
            int[] offset = new int[2];
            if (layoutManager instanceof CrashPagerGridLayoutManager) {
                CrashPagerGridLayoutManager manager = (CrashPagerGridLayoutManager) layoutManager;
...
//            Loge("findTargetSnapPosition, velocityX = " + velocityX + ", velocityY" + velocityY);
            if (null != layoutManager && layoutManager instanceof CrashPagerGridLayoutManager) {
                CrashPagerGridLayoutManager manager = (CrashPagerGridLayoutManager) layoutManager;
...
//            Loge("findTargetSnapPosition, target = " + target);
        ...
        public boolean onFling(int velocityX, int velocityY) {
            ...
            return (Math.abs(velocityY) > 1000 || Math.abs(velocityX) > 1000)
